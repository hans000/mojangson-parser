...
describe('基础语法测试', () => {
    ...
    test('bedrock nbt', () => {
      const a = `{"Block":{"name":"minecraft:sand","states":{"sand_type":"normal"},"version":17959425},"Count":1b,"Damage":0s,"Name":"minecraft:sand","WasPickedUp":0b}`
      expect(parse(a)).toEqual({
        Block: {
          name: 'minecraft:sand',
          states: { sand_type: 'normal' },
          version: '17959425'
        },
        Count: '1b',
        Damage: '0s',
