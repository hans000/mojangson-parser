...
const data9 = `{Attributes: [{Base: 35.0d, Modifiers: [{Amount: -0.03725403717515079d, Operation: 1, UUID: [I; 993841399, -205437223, -1567823694, 1846143518], Name: "Random spawn bonus"}], Name: "minecraft:generic.follow_range"}]}`
try {
    const b = parse(data9)
} catch (error) {
    console.log(error);
